      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            ...
            <h1 className="mb-4 font-serif text-2xl font-bold text-primary lg:text-3xl">
              {product.name}
            </h1>
            ...
            {/* Specs */}
            <div className="mb-6 grid grid-cols-3 gap-3 rounded-sm bg-cream p-4">
              <div className="text-center">
                <div className="mb-1 flex justify-center text-primary">
                  <Ruler size={20} />
                </div>
                <div className="text-xs text-gray-500">Chiều dài</div>
                <div className="text-sm font-semibold text-primary">{product.length}</div>
              </div>
              <div className="border-x border-white text-center">
                <div className="mb-1 flex justify-center text-primary">
                  <Circle size={20} />
                </div>
                <div className="text-xs text-gray-500">Ring Gauge</div>
                <div className="text-sm font-semibold text-primary">{product.ringGauge}</div>
              </div>
              <div className="text-center">
                <div className="mb-1 flex justify-center text-primary">
                  <Cigarette size={20} />
                ...
                <div className="text-sm font-semibold text-primary">{product.shape}</div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <button className="flex flex-1 items-center justify-center gap-2 rounded-sm bg-primary px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-primary-dark">
                <ShoppingBag size={18} />
                Thêm vào giỏ
              </button>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-sm bg-cream p-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-primary">{product.origin}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-sm bg-cream p-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-primary">{product.smokingTime}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 rounded-sm bg-cream p-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary">
                ...
                <div className="flex items-center gap-3 rounded-sm bg-cream p-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-primary">{product.tastingNotes.slice(0, 2).join(', ')}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-sm bg-white p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-2">
                {product.tastingNotes.map((note) => (
                  <span
                    key={note}
                    className="rounded-full bg-cream px-4 py-2 text-sm font-medium text-primary"
                  >
                    {note}
                  </span>
                ))}
          ...
          <div className="space-y-6">
            <div className="rounded-sm bg-white p-6 shadow-sm">
              <h3 className="mb-4 font-serif text-base font-semibold text-primary">
                Bảng độ nặng
              </h3>
                ...
                {Object.entries(strengthLabels).map(([key, { label, color, bgColor, textColor }]) => (
                  ...
                  >
                    ...
                    {product.strength === key && (
                      <span className="ml-auto text-xs font-medium text-primary">Đang chọn</span>
                    )}
                  </div>
                ))}
              </div>
              ...
              {relatedProducts.map((related) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="mb-2 font-serif text-base font-medium text-primary transition-colors group-hover:text-accent">
                      {related.name}
                    </h3>
